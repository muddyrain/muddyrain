import type { Form as AForm, ButtonProps, Cascader, CascaderProps, Checkbox, DatePicker, DatePickerProps, FormInstance, FormItemProps, FormProps, Input, InputProps, Radio, RadioGroupProps, Select, SelectProps, TimePicker, TimePickerProps, TreeSelect, TreeSelectProps } from 'antd';
...
export interface FormerProps {
     ...
     * 自定义渲染操作按钮
     */
    renderAction?: ((submit: () => void, reset: () => void) => JSX.Element) | null;
}
/**
 * antd 元素类型props
 */
...
export declare type CreateFormerProps = (Form: typeof AForm, options?: {
